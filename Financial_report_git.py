...
def summarize_news(df_streszczenia_to_AI):
    ...
    prompt = f"Przeanalizuj najnowsze wiadomości dotyczące {company_name} zawarte w tabeli:\n\n{table_string_indc}\n\n. Napisz krótkie podsumowanie wiadomości a w ostatnim zdaniu napisz pogrubieniem czy jest to negatywne lub neutralne lub pozytywne pod kątem inwestycji w akcje firmy {company_name}"
